...
const POSE_PRESETS = [
  ...
  { id: 'ANAK_SEPEDA', name: 'Anak Sepeda', icon: '🚲', prompt: 'Ultra realistic cinematic portrait photo, front view, a cheerful smiling child riding a bicycle directly toward the camera, subject positioned extremely close to the lens, upper body dominating the frame, face centered with happy expression and bright eyes, hands firmly gripping a bicycle handlebar, only the handlebar visible while the rest of the bicycle remains hidden outside the frame, legs naturally positioned and appearing to pedal the bicycle, dynamic riding pose, symmetrical composition, eye-level camera angle, 85mm lens, shallow depth of field, colorful street market alley in the background with vibrant snack carts and umbrellas in red, yellow, orange, blue and pink, lively atmosphere, bright sunny weather, warm daylight, soft cinematic bokeh, highly detailed skin texture, realistic shadows, professional photography, colorful bicycle with attractive bright colors matching the clothing or random vibrant colors, clean composition, energetic and joyful mood, masterpiece quality, ultra detailed, HDR, natural lighting. Negative Prompt: full bicycle visible, side view, wide shot, distant subject, standing pose, sitting on chair, motorcycle, car, stroller, multiple people, crowded foreground, cropped hands, cropped head, extra fingers, extra limbs, deformed anatomy, bad proportions, blurry image, low resolution, low quality, ugly face, serious expression, sad expression, crying, dark weather, rain, night scene, overexposed, underexposed, messy background, text, watermark, logo, duplicate person, tilted camera, fisheye distortion.' },
];
